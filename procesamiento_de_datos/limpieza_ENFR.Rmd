...
ENFR_limpia <- enfr_total %>% 
  select(ano_edicion, provincia, cumple_no_cumple_fy_v, genero, edad, rango_edad, nivel_de_instruccion, quintil_ingresos, indice_nbi_hogar_dic, promedio_fyv_dia, region)
